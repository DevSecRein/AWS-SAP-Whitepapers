...
- **Migrating to AWS: Best Practices**
    ...
    - [Link to Whitepaper](https://docs.aws.amazon.com/pdfs/prescriptive-guidance/latest/application-portfolio-assessment-guide/application-portfolio-assessment-guide.pdf#iterating-6-rs-migration-strategy-selection) (PDF)
